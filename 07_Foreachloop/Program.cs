...
namespace _07_Foreachloop
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //2. Değişken adı
            //3. In(şçşnde)
            //4. Liste, koleksiyon,Dizi nin adı
            ...
            #region Örenek Sınav Sistemi Uygulaması

            Console.Write("***** C# Eğiitim Kampı Sınav Uygulaması *****");
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine();
            ...
            for (int i = 0; i < studentCount; i++)
            {
                ...
                //Her öğrenci için 3 sınav notu girişşi
                for (int j = 0; j < 3; j++)
                {
